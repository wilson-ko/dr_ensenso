...
std::optional<NxLibItem> findCameraByLink(std::string const & linked_to, LogFunction const & logger = nullptr);
 ...
 */
std::optional<NxLibItem> findCameraByType(std::string const & type, LogFunction const & logger = nullptr);
 ...
 * \throws if opening the camera fails.
 */
std::optional<NxLibItem> openCameraByLink(std::string const & serial, LogFunction const & logger = nullptr);
 ...
 * \throws if opening the camera fails.
 */
std::optional<NxLibItem> openCameraByType(std::string const & type, LogFunction const & logger = nullptr);
